package com.cronappcc.springboot.configuration;
...
@Configuration
@Profile("local")
@EnableJpaRepositories(basePackages = "com.cronappcc.springboot.repository",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.cronappcc.springboot.model" });
